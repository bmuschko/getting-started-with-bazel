...
* (Optional) An installation of OpenJDK 21 ([instructions](https://openjdk.java.net/install/)). Bazel runs typical Java tasks like compilation, and testing within a sandboxed environment. The sandboxed environment will automatically download, install, and use Java 21. An installation of the JDK is only needed if you want to run Java commands independent from a Bazel invocation.
